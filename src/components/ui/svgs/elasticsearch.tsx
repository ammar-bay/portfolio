...
const Elasticsearch = (props: SVGProps<SVGSVGElement>) => (
  <svg {...props} viewBox="0 0 128 128" xmlns="http://www.w3.org/2000/svg">
    <path className="fill-[#343741] dark:fill-white" d="M4 64c0 5.535.777 10.879 2.098 16H84c8.836 0 16-7.164 16-16s-7.164-16-16-16H6.098A63.738 63.738 0 0 0 4 64" />
